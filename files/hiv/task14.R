...
output(prevalence_all) <- (I_h+I_l)/N_all
output(new_infections_h) <- lambda_h*S_h
output(new_infections_l) <- lambda_l*S_l
output(new_infections_all) <- lambda_h*S_h+lambda_l*S_l
output(incidence_h) <- lambda_h
output(incidence_l) <- lambda_l
output(incidence_all) <- (lambda_h*S_h+lambda_l*S_l)/(S_h+S_l)
